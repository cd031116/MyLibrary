...
public class SettingsXmlParser {
    ...
    static Map<String, Setting> parseSettings(Context context, String fileName) {
        ...
        try {
            ...
            TLog.d("read xml resource, filename = " + fileName);
                ...
                switch(eventType) {
                    ...
                    case 3:
                        if("setting".equals(xmlResParser.getName())) {
                            ...
                            TLog.d("AppSettingsXmlParser", String.format("parse new setting --->%s", new Object[]{JSON.toJSONString(readSetting)}));
                            readSetting = null;
                        }

                        if("setting-array".equals(xmlResParser.getName())) {
                            settingArray.add(readSettingArray);
                            TLog.d("AppSettingsXmlParser", String.format("parse new settingArray --->%s", new Object[]{JSON.toJSONString(readSettingArray)}));
                        ...
                        if("extra".equals(xmlResParser.getName())) {
                            ...
                            TLog.d("AppSettingsXmlParser", String.format("parse new settingExtra --->%s", new Object[]{JSON.toJSONString(settingExtras)}));
                            readSettingExtra = null;
                        }
                }
            }
        } catch (Exception var18) {
            TLog.printExc(SettingsXmlParser.class, var18);
        } finally {
            ;
        }
