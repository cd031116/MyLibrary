...
public class SystemUtils {
    ...
    public static int getKeyboardHeight(Activity paramActivity) {
        ...
        if(height == 0) {
            height = ActivityHelper.getIntShareData(Adhibition.getInstance(), "KeyboardHeight", 400);
        } else {
            ActivityHelper.putIntShareData(Adhibition.getInstance(), "KeyboardHeight", height);
        }
    ...
    public static int getNavigationBarWidth(Context context) {
        Resources res = context.getResources();
        byte result = 0;
        return Build.VERSION.SDK_INT >= 14 && hasNavigationBar(context)?getInternalDimensionSize(res, "navigation_bar_width"):result;
    }
    ...
    public static void startActivity(Activity context, String packageName) {
        try {
            ...
            Logger.printExc(SystemUtils.class, var3);
        }
